...
# Database
# Check environment variable to determine database engine
...
if db_engine == 'sqlite3':
    ...
    DATABASES = {
        'default': {
            ...
            'PASSWORD': env('DB_PASSWORD', default='erp_password'),
...
# Company Settings
DEFAULT_CURRENCY = env('DEFAULT_CURRENCY', default='MAD')
DEFAULT_LOCALE = env('DEFAULT_LOCALE', default='fr-MA')

# Tax Settings
DEFAULT_VAT_RATE = env.float('DEFAULT_VAT_RATE', default=20.0)

# API Documentation
SPECTACULAR_SETTINGS = {
    'TITLE': 'ERP API',
    'DESCRIPTION': 'Advanced Stock & Invoicing ERP for Moroccan Companies',
    'VERSION': '1.0.0',
